...
export function Header() {
  return (
    <header className="bg-white/2 backdrop-blur-[3px] bg-gray-900/60 border-2 border-purple-500/20 shadow-[0_0_20px_rgba(168,85,247,0.15)] rounded-lg mb-8" role="banner">
