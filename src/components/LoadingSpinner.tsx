...
export function LoadingSpinner({ progress }: LoadingSpinnerProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12">
      <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-blue-400" role="img" aria-label="Loading spinner"></div>
      <p className="mt-4 text-gray-400" aria-live="polite">
        {progress
